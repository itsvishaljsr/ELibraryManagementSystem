                ...
                <div class="card">
                    <div class="card-body">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:Button class="btn btn-primary" ID="btnGetBookDetails" runat="server" Text="Go" OnClick="btnGetBookDetails_Click" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <asp:Button ID="btnReturnBook" class="btn btn-lg btn-block btn-success" runat="server" Text="Return" OnClick="btnReturnBook_Click" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="col-md-7">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="row">
                            <asp:SqlDataSource ID="sqlDSIssuedBookData" runat="server" ConnectionString='<%$ ConnectionStrings:elibraryDBConnectionString %>' SelectCommand="SELECT * FROM [book_issue_tbl]"></asp:SqlDataSource>
                            <div class="col">
                                <asp:GridView class="table table-striped table-bordered" ID="grdViewIssuedBooks" runat="server" AutoGenerateColumns="False" DataKeyNames="member_id" DataSourceID="sqlDSIssuedBookData" OnRowDataBound="grdViewIssuedBooks_RowDataBound">
                                    <Columns>
                                        <asp:BoundField DataField="member_id" HeaderText="Member ID" SortExpression="member_id" ReadOnly="True"></asp:BoundField>
